# From paper: Attention Augmented Convolution Networks(2020)
...
class AugmentedConv(torch.nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, dk, dv, Nh, padding=0, shape=0, stride=1):
        ...
        self.attn_out = torch.nn.Conv1d(self.dv, self.dv, kernel_size=1, stride=1)
