...
A deep learning-based **calibration transfer** framework for quantitative chemical analysis in infrared microscopic imaging. Enables spatially resolved, pixel-level quantitative IR spectroscopy by bridging the domain gap between macroscopic bulk measurements and microscopic hyperspectral images. Published in *Analytical Chemistry* (2025).
